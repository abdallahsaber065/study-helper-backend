...
if _celery_available:
    ...
    # Stub when Celery is not installed (e.g. during unit tests)
    class _StubCeleryApp:  # type: ignore[no-redef]
        """Minimal stub so that imports don't fail when Celery is absent."""
    ...
    celery_app = _StubCeleryApp()  # type: ignore[assignment]
