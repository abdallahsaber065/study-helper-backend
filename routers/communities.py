...
def _convert_subject_link_to_read(link: CommunitySubjectLink) -> CommunitySubjectLinkRead:
...
async def create_community(
    ...
    # Add counts manually to avoid lazy loading issues
    result = CommunityRead(
        ...
        community_code=created_community.community_code,
        creator_id=created_community.creator_id,
...
async def list_communities(
    ...
    for community in communities:
        ...
        # Create CommunityRead manually to avoid lazy loading issues
...
async def get_community(
    ...
    # Create detailed response manually to avoid lazy loading issues
    community_details = CommunityWithDetails(
        id=community.id,
        name=community.name,
        description=community.description,
        is_private=community.is_private,
        ...
        subjects=subject_reads,
        member_count=len(member_reads),
        subject_count=len(subject_reads)
    )
...
async def update_community(
    ...
    result = CommunityRead(
        ...
        community_code=updated_community.community_code,
